    ...
    return (
        <div className="flex flex-col justify-between lg:justify-center gap-1.5 h-full">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-1.5 items-stretch h-full">
                <div className="flex items-center gap-2 bg-green-700 rounded-lg px-3 py-1.5 sm:py-3 h-full">
                    <span className="text-white font-semibold text-sm xl:text-xl">
                        Run #{run.runNumber}
                    </span>
                </div>
                <div className="bg-blue-500/20 rounded-lg px-3 py-1.5 sm:py-3 w-full text-center flex flex-col justify-center h-full">
                ...
                <div
                    className={`${
                        run.deadPokemon > 0
                            ? 'bg-red-500/30'
                            : 'bg-green-500/20'
                    } rounded-lg px-3 py-1.5 sm:py-3 text-center flex flex-col justify-center h-full`}>
